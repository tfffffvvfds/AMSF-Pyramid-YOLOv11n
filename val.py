...
if __name__ == '__main__':
    model = YOLO(r'G:\sc\ultralytics-yolo11-main\Aown-yolo\runs\detect\train48\weights\best.pt') # 选择训练好的权重路径
    model.val(data=r'G:\sc\ultralytics-yolo11-main\2\data.yaml',
